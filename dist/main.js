...
(() => {
  ...
  var Shared = class _Shared {
    ...
    static get shaderEditorCode() {
      if (!_Shared.shaderEditor) {
        throw new Error("Editor not found");
      }
      return _Shared.shaderEditor.state.doc.toString();
    }
  ...
  // html-asset:/Users/jordi.izquierdo/Documents/Repositories/webgpu-editor/src/components/absoluteInterface/index.html
  var absoluteInterface_default = "index-a61f20c70af57f93.html";

  // src/components/absoluteInterface/index.ts
  var AbsoluteInterface = class extends HTMLElement {
    constructor() {
      super();
    }
    connectedCallback() {
      this.innerHTML = absoluteInterface_default;
      const exitFullscreenButtonEl = safeQuery("#exit-fullscreen-btn");
      exitFullscreenButtonEl.addEventListener("click", () => shared_default.toggleFullscreen);
    }
  };
  customElements.define("absolute-interface", AbsoluteInterface);

  // html-asset:/Users/jordi.izquierdo/Documents/Repositories/webgpu-editor/src/components/codeEditorToolbar/index.html
  var codeEditorToolbar_default = "index-8445d9cb986c0cf7.html";

  // src/components/codeEditorToolbar/index.ts
  var CodeEditorToolbar = class extends HTMLElement {
    constructor() {
      super();
    }
    connectedCallback() {
      this.innerHTML = codeEditorToolbar_default;
      const drawButtonEl = safeQuery("#draw-btn");
      drawButtonEl.addEventListener("click", this.saveShaderCode);
      const fullscreenButtonEl = safeQuery("#fullscreen-btn");
      fullscreenButtonEl.addEventListener("click", shared_default.toggleFullscreen);
      const githubButtonEl = safeQuery("#github-btn");
      githubButtonEl.addEventListener("click", this.redirectToGithub);
      const aspectRatioButtonEl = safeQuery("#toggle-aspect-ratio-btn");
      aspectRatioButtonEl.addEventListener("click", () => this.toggleAspectRatio);
    }
    saveShaderCode() {
      localStorage.setItem("shaderCode", shared_default.shaderEditorCode);
      shared_default.needsUpdate = true;
    }
    redirectToGithub() {
      window.open("https://github.com/izquiratops/wgsl-playground", "_blank");
    }
    toggleAspectRatio() {
      const canvasEl = safeQuery("#canvas");
  ...
  var parserWithMetadata = parser.configure({
    props: [
      styleTags({
  ...
  var wgslLanguage = LRLanguage.define({
    name: "wgsl",
  ...
  var Renderer = class {
    ...
    updatePipeline() {
      const shaderCode = shared_default.shaderEditorCode;
      ...
      shared_default.needsUpdate = false;
      return { pipeline, uniformsBuffer };
    }
  };
  var renderer_default = Renderer;

  // src/utils/editorTheme.json
  var editorTheme_default = {
    UpperBar: [
      {
        "--theme-primary": "#F05A7E",
        "--theme-secondary": "#ff7799",
        "--theme-detail": "#FFF"
      }
    ]
  };
  ...
  var Editor = class {
    ...
    setupTheme() {
      const currentTheme = editorTheme_default["UpperBar"][0];
    ...
    setupCodemirror() {
      const vertexCode = localStorage.getItem("shaderCode") ?? default_default;
      shared_default.shaderEditor = new EditorView({
        doc: vertexCode,
    ...
    setupHotkeys() {
      document.addEventListener("keydown", (event) => {
        if (event.key === "Escape") {
          shared_default.toggleFullscreen();
        }
      });
    }
    async initializeWebGPU() {
      ...
      if (context && "gpu" in navigator) {
        ...
        shared_default.renderer = new renderer_default(device, canvasEl, context);
        shared_default.renderer.render();
  ...
  // html-asset:/Users/jordi.izquierdo/Documents/Repositories/webgpu-editor/src/components/codeEditorView/index.html
  var codeEditorView_default = "index-c541a4d218c1595d.html";

  // src/components/codeEditorView/index.ts
  var CodeEditorView = class extends HTMLElement {
    constructor() {
      super();
    }
    connectedCallback() {
      this.innerHTML = codeEditorView_default;
      const editor = new editor_default();
      editor.setupCodemirror();
      editor.setupHotkeys();
      editor.setupTheme();
      editor.initializeWebGPU().catch(() => {
        const errorModalEl = safeQuery("#error-modal");
  ...
  // html-asset:/Users/jordi.izquierdo/Documents/Repositories/webgpu-editor/src/components/errorModal/index.html
  var errorModal_default = "index-c232cf61edfde058.html";
  ...
  var ErrorModal = class extends HTMLElement {
    ...
    connectedCallback() {
      this.innerHTML = errorModal_default;
    }
  };
  customElements.define("error-modal", ErrorModal);

  // src/components/verticalSlider/index.ts
  var VerticalSlider = class extends HTMLElement {
    constructor() {
      super();
      this.editorContainerEl = safeQuery(".editor-container");
      this.resizeCanvasEvent = (e) => {
